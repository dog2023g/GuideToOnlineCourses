...
const language={
    ...
    "card_link_3_lesson":{
        "ru": '<div class="card-body"><h5 class="card-title">Регистрация на курс</h5><p class="card-text">Объясним, как записаться на онлайн-курсы</p><a href="'+lesson_3+'?lang=ru&" class="btn btn-success">Перейти!</a></div>',
